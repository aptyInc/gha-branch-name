...
try {
  ...
  const validBranchRegex = /(^(revert)-[0-9]{1,5}-(feature|bugfix|hotfix|onprem|test)\/(LSP|CS|SS|CB|AQRE|LP|ASE|CED|SAP|FR|SBT|AMA|NCCE)-[0-9]{1,5}\/[0-9a-zA-Z_-]+$)|(^(feature|bugfix|hotfix|onprem|test)\/(LSP|CS|SS|CB|AQRE|LP|ASE|CED|SAP|FR|SBT|AMA|NCCE)-[0-9]{1,5}\/[0-9a-zA-Z_-]+$)|(^(development|staging|production|qa|qa1|hotfix|labs|demo|onprem|nightly|automation)$)|((rc)-\d*.\d*.\d*-?\w*)/;
