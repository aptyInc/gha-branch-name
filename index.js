...
try {
  ...
  const validBranchRegex = /(^(revert)-[0-9]{1,5}-(feature|bugfix|hotfix|onprem)\/(LSP|CB|AQRE|LP|ASE|CED|SAP)-[0-9]{1,5}\/[0-9a-zA-Z_-]+$)|(^(feature|bugfix|hotfix|onprem)\/(LSP|CB|AQRE|LP|ASE|SAP)-[0-9]{1,5}\/[0-9a-zA-Z_-]+$)|(^(development|staging|production|qa|labs|onprem)$)|(snyk-\w*-\w*)/;
